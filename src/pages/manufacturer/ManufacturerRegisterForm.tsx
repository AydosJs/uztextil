...
function ManufacturerRegisterForm() {
  ...
  const department =
    (location.state as { department?: "customer" | "manufacturer" })
  ...
  const [filteredSegments, setFilteredSegments] = React.useState<
    MultiSelectOption[]
  >([]);
  ...
  const onSubmit = useCallback(
    async (data: ManufacturerRegisterFormData) => {
      ...
      try {
        ...
        formData.append(
          "has_quality_control",
          data.qualityControl === "yes" ? "true" : "false"
        );
        formData.append("has_crm", data.crmSystem === "yes" ? "true" : "false");
        formData.append("has_erp", "false");
        formData.append(
          "has_gemini_gerber",
          data.geminiGerber === "yes" ? "true" : "false"
        );
        formData.append(
          "employee_count",
          (parseInt(data.employeesCount || "0") || 0).toString()
        );
        formData.append(
          "owns_building",
          data.buildingOwnership === "own" ? "true" : "false"
        );
        formData.append(
          "has_power_issues",
          data.industrialZone === "yes" ? "true" : "false"
        );
        formData.append(
          "is_located_zone",
          data.industrialZone === "yes" ? "true" : "false"
        ...
        formData.append(
          "has_credit_load",
          data.creditBurden === "yes" ? "true" : "false"
        );
        formData.append(
        ...
        formData.append(
          "annual_export_turnover",
          data.annualExportTurnover || ""
        );
        ...
        if (data.commercialOffer && data.commercialOffer instanceof File) {
          ...
          console.log(
            "Commercial offer PDF added to FormData:",
            data.commercialOffer.name,
            data.commercialOffer.size,
            data.commercialOffer.type
          );
        } else {
          console.log(
            "No commercial offer PDF file or invalid file:",
  ...
  const handleSelectChange = useCallback(
    (field: keyof ManufacturerRegisterFormData, value: string | number) => {
      setValue(
        field,
  ...
  const handleRadioChange = useCallback(
    (field: keyof ManufacturerRegisterFormData, value: string) => {
      setValue(
        field,
        value as ManufacturerRegisterFormData[keyof ManufacturerRegisterFormData],
        { shouldValidate: false }
      ...
      <main className="w-full max-w-4xl mx-auto container min-w-full flex-1 flex flex-col">
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              placeholder={t(
                "app.buyurtmachi.registerForm.companyName.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <CompanyImageUploader
              ...
              onImageIdsChange={(imageIds) => {
                setValue("companyImageIds", imageIds, {
                  shouldValidate: false,
                  shouldDirty: false,
                });
              }}
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              placeholder={t(
                "app.buyurtmachi.registerForm.fullName.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              placeholder={t(
                "app.buyurtmachi.registerForm.addition_fio.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              placeholder={t(
                "app.buyurtmachi.registerForm.position.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <MultiSelectCombobox
              ...
              placeholder={t(
                "app.buyurtmachi.registerForm.category.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              placeholder={t(
                "app.buyurtmachi.registerForm.companyRating.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              placeholder={t(
                "app.buyurtmachi.registerForm.annualExportTurnover.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              placeholder={t(
                "app.buyurtmachi.registerForm.exportCountries.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              placeholder={t(
                "app.buyurtmachi.registerForm.workedBrands.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              type="number"
              placeholder={t(
                "app.buyurtmachi.registerForm.experience.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              placeholder={t(
                "app.buyurtmachi.registerForm.minOrder.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              placeholder={t(
                "app.buyurtmachi.registerForm.productionAddress.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              placeholder={t(
                "app.buyurtmachi.registerForm.officeAddress.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              placeholder={t(
                "app.buyurtmachi.registerForm.website.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleSelectChange("qualityControl", value)
              }
            >
              <SelectTrigger error={errors.qualityControl?.message}>
                <SelectValue
                  placeholder={t("app.buyurtmachi.select.placeholder")}
                />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="yes">
                  {t("app.buyurtmachi.registerForm.qualityControl.options.yes")}
                </SelectItem>
                <SelectItem value="no">
                  {t("app.buyurtmachi.registerForm.qualityControl.options.no")}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="yes">
                  {t("app.buyurtmachi.registerForm.crmSystem.options.yes")}
                </SelectItem>
                <SelectItem value="no">
                  {t("app.buyurtmachi.registerForm.crmSystem.options.no")}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleSelectChange("geminiGerber", value)
              }
            >
              ...
              <SelectContent>
                <SelectItem value="yes">
                  {t("app.buyurtmachi.registerForm.geminiGerber.options.yes")}
                </SelectItem>
                <SelectItem value="no">
                  {t("app.buyurtmachi.registerForm.geminiGerber.options.no")}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            ...
            <CustomInput
              placeholder={t(
                "app.buyurtmachi.registerForm.employeesCount.placeholder"
              )}
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleSelectChange("buildingOwnership", value)
              }
            >
              ...
              <SelectContent>
                <SelectItem value="own">
                  {t(
                    "app.buyurtmachi.registerForm.buildingOwnership.options.own"
                  )}
                </SelectItem>
                <SelectItem value="rented">
                  {t(
                    "app.buyurtmachi.registerForm.buildingOwnership.options.rented"
                  )}
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleSelectChange("industrialZone", value)
              }
            >
              ...
              <SelectContent>
                <SelectItem value="yes">
                  {t("app.buyurtmachi.registerForm.industrialZone.options.yes")}
                </SelectItem>
                <SelectItem value="no">
                  {t("app.buyurtmachi.registerForm.industrialZone.options.no")}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleSelectChange("creditBurden", value)
              }
            >
              ...
              <SelectContent>
                <SelectItem value="yes">
                  {t("app.buyurtmachi.registerForm.creditBurden.options.yes")}
                </SelectItem>
                <SelectItem value="no">
                  {t("app.buyurtmachi.registerForm.creditBurden.options.no")}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-2">
            ...
            >
              <RadioGroup
                ...
                onValueChange={(value) =>
                  handleRadioChange("organizationStructure", value)
                }
              >
                <div className="flex items-center space-x-3">
                  ...
                  >
                    {t(
                      "app.buyurtmachi.registerForm.organizationStructure.options.director"
                    )}
                  </Label>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  >
                    {t(
                      "app.buyurtmachi.registerForm.organizationStructure.options.manager"
                    )}
                  </Label>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  >
                    {t(
                      "app.buyurtmachi.registerForm.organizationStructure.options.marketer"
                    )}
                  </Label>
                </div>
              </RadioGroup>
